          ...
          <SwiperSlide key={index}>
            <section className="my-8 ">
              <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8" bis_skin_checked="1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#094680" className="w-16 h-16 ">
                ...
                <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-xl md:text-2xl lg:max-w-2xl xl:max-w-4xl ">{testimonial.test}</p>
