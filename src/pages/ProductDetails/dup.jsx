      ...
      <section className="relative flex flex-col  overflow-hidden">
        <div >
            ...
            <div className="grid grid-cols-1  lg:grid-cols-2 gap-2 lg:gap-16 lg:mx-10 lg:mt-10  ">
              ...
              <div className="data w-full lg:pr-8 pr-0 xl:justify-start relative  lg:justify-center flex items-center max-lg:pb-10 xl:my-2 lg:my-5 my-0">
                <div className="data sm:w-full max-w-xl">
                  ...
                  <h2 className="font-bold text-3xl text-black mb-2 capitalize">
                    {products?.attributes?.ProductName}
                  </h2>
                  <h3 className="font-bold text-xl text-gray mb-2 capitalize">
                  ...
                  <div className="flex flex-row gap-2 sm:flex-row  sm:items-center mb-6">
                    {products?.attributes?.Offer ? (
                      <>
                        <h6 className="font-manrope font-semibold text-3xl leading-9 text-green  ">
                          &#8377;{OfferPrice}
                        </h6>
                        <h6 className="font-manrope  font-semibold text-xl line-through leading-9 text-gray ">
                          &#8377;{products?.attributes?.Price}
                        </h6>
                        <span className="text-x text-gray font-bold"> {products?.attributes?.Offer}{" "}% Off</span>
                      </>
                    ) : (
                      <h6 className="font-manrope font-semibold text-3xl leading-9 text-green ">
                        &#8377;{products?.attributes?.Price}
                  ...
                  <div className="flex flex-col gap-2   mb-6">
                    <h6 className="font-manrope font-normal text-xl text-gray   ">
                    ...
                    {
                      products?.attributes?.AvailableQuantity === 0 || disableCart || products?.attributes?.AvailableQuantity === null ? null : (<h6 className="font-manrope font-normal text-2xl text-gray   ">
                        <span className="font-bol text-gray text-xl">Available Quantity -</span> Only {products?.attributes?.AvailableQuantity} left
                      </h6>)
                    }
                  </div>
                  <>
                    <div className="flex  gap-3 py-2">
                      {products?.attributes?.AvailableQuantity === 0 || disableCart || products?.attributes?.AvailableQuantity === null ?
                        (
                          <p className='text-white px-2 py-1 rounded font-bold text-2xl bg-red'>Out Of Stock</p>
                        ) : (
                          <>
                            <div className="flex sm:items-center gap-3  ">
                              <select
                                aria-label="Select quantity"
                                class="py-2 px-3 bg-white rounded-m text-gray mr-6 focus:outline-none "
          ...
          <div className="md:pt-5 pt-0 mb-10 px-4 lg:px-16 flex flex-col gap-3">
            ...
            <ul className='text-base list-disc list-insid text-gray font-semibold text-justify'>
        ...
        <section className='flex gap-10 px-5 md:px-20 py-10 md:flex-row flex-col-reverse  mb-20 justify-between items-center bg-red'>
          ...
          <div className="md:w-1/2 w-full bg-white mx-auto p-6 shadow rounded-lg">
            ...
            {/* Comment Section */}
            <textarea
  className="w-full p-3 border rounded-md focus:ring-gray focus:ring  mb-4"
  rows="4"
...
/>
      ...
      <div className="mb-4">
        ...
        {imagePreview && (
          ...
          <div className="md:w-1/2 w-full bg-white p-5 mx-auto mt-8 rounded-lg">
            ...
            {Review?.attributes?.reviews?.data?.length > 0 ? (
              <div className="space-y-6 h-96 overflow-y-scroll auto">
                {Review?.attributes?.reviews?.data?.map((review) => (
                  <div
                    key={review.id}
                    className="p-4 bg-red text-white rounded-md shadow-sm"
                  >
                    {/* Header */}
